...
class Bird { 
    ...
    move() { 
        ...
        var damping = 1.4;
        this.velocity = (this.velocity + Constants.GRAVITY * dt) / (1 + damping * dt);
    ...
    collideBot(pipe) { 
        return ((this.y <= pipe.getTopY() || this.birdBot >= pipe.getBotY()) && 
    ...
    collide(pipes) {
        ...
        return result.length >= 1 || this.y <= 0 || this.birdBot >= Constants.HEIGHT;
    }
}
